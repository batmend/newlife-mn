const AUTH_MESSAGES: Record<string, string> = {
  ...
  email_not_confirmed: "Имэйл хаягаа баталгаажуулаагүй байна. Ирсэн захидлын холбоос дээр дарна уу.",
  user_already_exists: "Энэ имэйлээр бүртгэл аль хэдийн үүссэн байна. Нэвтэрнэ үү.",
  email_exists: "Энэ имэйлээр бүртгэл аль хэдийн үүссэн байна. Нэвтэрнэ үү.",
